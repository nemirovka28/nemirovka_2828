          ...
          n = function() {
              ...
              return d(c, [{
                  ...
                  value: function(a) {
                      ...
                      // this._2(), this._4(a.getAttribute("data-dial-code"), !0), this.a.focus(); // чтобы была сразу фокусировки в поле
                      this._2(), this._4(a.getAttribute("data-dial-code"), !0); // чтобы не было сразу фокусировки в поле
